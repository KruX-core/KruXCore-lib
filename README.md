...
This is the library for KruX Core, a coin built on top of NodeJS and CryptoJS.

## Thanks to

- [TheDevMinerTV](https://github.com/TheDevMinerTV) for making the base library [node-libblockchain](https://github.com/TheDevMinerTV/node-libblockchain) 
